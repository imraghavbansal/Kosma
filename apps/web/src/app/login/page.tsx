        ...
        <div className="relative z-10 w-full max-w-sm animate-fade-in">
          ...
          <div className="rounded-xl border border-border bg-surface p-8 shadow-sm">
            ...
            <div className="my-5 flex items-center gap-3">
              ...
              <span className="text-[10px] font-medium tracking-wider text-muted">OR</span>
              <div className="h-px flex-1 bg-border" />
            </div>

            <a
              href="/api/v1/auth/github/login"
              className="flex w-full items-center justify-center gap-2 rounded-md border border-border bg-surface-2 px-3 py-2 text-sm font-medium text-foreground transition-all duration-150 ease-premium hover:bg-border active:scale-[0.98]"
            >
          ...
          <p className="mt-6 text-center text-xs text-muted">
            Shared-secret or GitHub, both are equally-privileged sessions on this
            single-tenant deployment - see <span className="font-mono">docs/architecture.md</span>.
          </p>
        </div>
      </div>
